...
<div class="row"> 
        ...
        <div class="row">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" <?php if ($_SESSION["status"]  == 1){?>
                                             href="../table_admin.php" <?php }
                                             else { ?> href="../table.php" <?php } ?>
                                    >Tableau</a>
                        </li>
                        <li class="nav-item">
            ...
            <?php } ?>
                ...
                <form action = '#' class="form-inline d-sm-none d-md-block" id="search" role="search" method="post"> 
                        ...
                        <input type="search"  id="search-imput" name="discount" spellcheck="false" placeholder="Votre promotion"> 
    ...
    <body>
        ...
        <?php
            echo "<h1 class='d-flex justify-content-center'>"."Vous n'êtes pas autorisé à accederà cette page."."</h1>";
