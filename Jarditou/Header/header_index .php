        ...
        <div class="row">
            ...
            <?php } ?>
                ...
                <form action = '#' class="form-inline d-sm-none d-md-block" id="search" role="search" method="post"> <!--form inline pour la même ligne, d-none et block supprime en dessous de md-->
                        ...
                        <input type="search"  id="search-imput" name="discount" spellcheck="false" placeholder="Votre promotion"> <!--spellckeck analyse orthographe, placeholder message pour champs obligatoire-->
