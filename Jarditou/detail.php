        ...
        <div class="container"> 
            ...
            <form name="Détail produit" id="Détail produit">
                <div class="form-group">
                    ...
                    <label for="pro_cat_id"><b>Catégorie :</b></label><input type="text" class="form-control" name="nomProduit" id="nomProduit" value="<?php echo $produit->cat_nom?>" Readonly>
            ...
            <div class="d-flex justify-content-center" name = productAction>
                <a  class="btn" href="table.php"><button class="btn-secondary">Retour</button></a>
            </div>
